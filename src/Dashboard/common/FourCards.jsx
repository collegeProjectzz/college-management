...
export default function FourCards({ one, two, three, four }) {
    return (
        <div className="h-auto flex flex-row flex-wrap w-full justify-center items-center">
            <div className="flex items-center justify-center flex-col w-4/12 m-2">
                <div className="w-full p-2 bg-white rounded-lg cursor-pointer drop-shadow-xl hover:drop-shadow-2xl">
                    {one}
                </div>
            </div>
            <div className="flex items-center justify-center flex-col w-7/12 m-2">
